    ...
    <body>
            ...
            <nav class="navbar navbar-expand-sm navbar-default">
                ...
                <div id="main-menu" class="main-menu collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            <a href="./developers.php" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-code" aria-hidden="true" style="color: white;"></i>አበልጻጊ</a>
                        </li>
        ...
        <div id="right-panel" class="right-panel">
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">ይቋርጡ</button>
            ...
            if (mysqli_connect_errno()) {
                ...
                school.name, tds.school, teacher_level.level_name, tds.teacher_level, association.asso_name, tds.association, tds.warranty, tds.salary, tds.shelf, tds.kent, tds.phone, 
                tds.image, tds.other_service, tds.reduced_service, tds.warranter_jop, tds.warranter_name, tds.warranter_salary, tds.warranter_photo, tds.registered_by
                FROM tds
                ...
                ON tds.association=association.asso_id WHERE tds.tds_id = $teacherId";
                                    ...
                                    <div class="scroll">
                                        <table id="example" class="display table table-striped table-bordered" style="width:100%">
                                            ...
                                            while ($row = mysqli_fetch_array($result)) {
                                                ...
                                                $update = '<a href="update teacher.php?tds_id=' . $tds_id .
                                                    '&fname=' . $fname .
                                                    '&mname=' . $mname .
                                                    '&lname=' . $lname .
