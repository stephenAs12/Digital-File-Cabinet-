...
?>
    ...
    <body>
            ...
            <div class="content mt-3">
                <div class="animated fadeIn">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-header">Add Education Level</div>
                                <div class="card-body card-block">
                                    <form id="edu_level_id">
                                        <div class="form-group">
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-building"></i></div>
                                                <input type="text" id="level_id" name="level_name"  class="form-control" autocomplete="off" required>
                                            </div>
                                        </div>
        ...
        <script src="./insert_level.js"></script>
