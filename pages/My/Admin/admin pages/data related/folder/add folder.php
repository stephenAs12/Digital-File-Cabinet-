...
?>
    ...
    <body>
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                ...
                                <div class="card-body card-block">
                                    <form id="folder_form_id">
                                        <div class="form-group">
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-building"></i></div>
                                                <input type="text" id="folder_id" name="folder_name" placeholder="Folder Name"  class="form-control" autocomplete="off" required>
                                            </div>
                                        </div>
        ...
        <script src="./insert folder.js"></script>
