                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    <table id="example" class="display table table-striped table-bordered" style="width:100%">
                                        ...
                                        // $sql = "SELECT name,level,association FROM school";
                                        $sql="SELECT school.name,school.level,association.asso_name FROM school INNER JOIN association ON  school.association=association.asso_id";
                                        ...
                                        if ($result) {
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                if($school==1)
                                                {
                                                    ...
                                                    $school_level="Secondary School";
                                                    
                                                }

                                                $association = $row['asso_name'];
                                                echo '<tr>
                                                        <td>' . $name . '</td>
                                                        <td>' . $school_level. '</td>
                                                        <td>' . $association .'</td>
