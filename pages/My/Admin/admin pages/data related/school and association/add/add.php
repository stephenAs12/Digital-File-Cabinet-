                ...
                <div id="main-menu" class="main-menu collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-plus-square" style="color: white;"></i><a href="../../../data related/school and association/add/add.php"><span style="color: white;">Add</span></a></li>
            ...
            <div class="content mt-3">
                <div class="animated fadeIn">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-header">Add Association</div>
                                <div class="card-body card-block">
                                    <form id="association_form_id">


                                        <div class="form-group">
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-building"></i></div>
                                                <input type="text" id="association_id" name="association_name" placeholder="Association *" class="form-control" autocomplete="off" required>
                                            </div>
                                        </div>

                                        <div class="form-actions form-group">
                                            <button type="reset" class="btn btn-danger btn-sm">Clear</button>
                                            <button type="submit" id="association_submit_id" name="submit" class="btn btn-success btn-sm">Submit</button>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body card-block">
                                    <form id="school_form_id" class="">
                                        ...
                                        <div>
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="school_name_id" name="school_name_name" placeholder="School Name *" class="form-control" autocomplete="off" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <select name='school_level_name' id='school_level_id' class='form-control' required>
                                                        <option value='' selected hidden>Please select school level *</option>
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <?php
                                                    include 'add/get association.php';
                                                    echo "<div class='input-group-addon'><i class='fa fa-building' aria-hidden='true'></i></div>";
                                                    echo "<select name='association_selection_name' id='association_selection_id' class='form-control' required>";
                                                    echo "<option value='' selected hidden>Please select school association *</option>";
                                        ...
                                        <div class="form-actions form-group">
                                            <button type="reset" class="btn btn-danger btn-sm">Clear</button>
                                            <button type="submit" id="selection_submit_id" name="submit" class="btn btn-success btn-sm">Submit</button>
