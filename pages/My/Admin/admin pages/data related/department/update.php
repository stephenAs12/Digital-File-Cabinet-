...
if (isset($_SESSION['user_id']) && isset($_SESSION['user_email']) && isset($_SESSION['user_role']) && $_SESSION['user_role'] == 'Admin') {
?>
    <!doctype html>
            ...
            <nav class="navbar navbar-expand-sm navbar-default">
                ...
                <div id="main-menu" class="main-menu collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        <li>
                            <script src=""></script>
                            <a href="../admin/admin index.php"> <i class="menu-icon fa fa-dashboard"></i>Dashboard </a>
                        </li>
                            ...
                            <div class="card-body card-block">
                                <form id="add_user_form" class="">
                                    ...
                                    <div>
                                        <div class="form-group col-md-4">
                                            <div class="input-group">
                                                ...
                                                <select name="education_level_name" id="education_level_id" class='form-control' required>
                                                    <option value="" selected disabled hidden>Select TDS</option>
                                                    <option value="Master">Teacher</option>
                                                    <option value="Degree">Director</option>
                                                    <option value="Linear">Supervisor</option>
                                        ...
                                        <div class="form-group col-md-4">
                                            <div class="input-group">
                                                <div class="input-group-addon"><h6 style="width:60px; hight:10px;">Birth Date</h6>
                                                </div>
                                        ...
                                        <div class="form-group col-md-4">
                                            <div class="input-group">
                                            <div class="input-group-addon"><h6 style="width:60px;"  >Emp_Period</h6>
                                                </div>
                                                <!-- <div class="md-form md-outline input-with-post-icon datepicker" id="customDays"> -->
                                                <input name="employment_period_name" placeholder="Select date" type="date" id="employment_period_id" class="form-control" minlength="10" maxlength="10" required>
                                                <!-- <i class="fas fa-calendar input-prefix" tabindex=0></i> -->
                                        ...
                                        <div class="form-group col-md-4">
                                            <div class="input-group">
                                                ...
                                                <select name="education_level_name" id="education_level_id" class='form-control' required>
                                                    <option value="" selected disabled hidden>Education Level</option>
                                                    <option value="Master">2nd Degree</option>
                                                    <option value="Degree">1st Degree</option>
                                                    <option value="Linear">Linear</option>
                                                    <option value="Linear">Claster</option>
                                        ...
                                        <div class="form-group col-md-4">
                                            <div class="input-group">
                                                ...
                                                <select name="education_level_name" id="education_level_id" class='form-control' required>
                                                    ...
                                                    <option value="Master">Amharic</option>
                                        ...
                                        <div class="form-group col-md-4">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" type="password" id="user_password_id" name="user_password_name" placeholder="Password" minlength="5" required>
                                            </div>
                                        </div>
                                    </div>
