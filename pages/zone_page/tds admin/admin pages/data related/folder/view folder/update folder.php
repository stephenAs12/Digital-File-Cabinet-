...
?>
    ...
    <body>
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li><a href="./view folder.php">አቃፊን ይመልከቱ</a></li>
                                <li class="active">አቃፊን ይቀይሩ</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="col-md-12">
                                        <strong class="card-title">አቃፊን ይቀይሩ</strong>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <?php
                                    ...
                                    <div class="card-body card-block">
                                        <form id="update_folder_form" class="">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <div class="input-group-addon"><i aria-hidden="true">የአቃፊ ስም</i></div>
                                                    <input type="text" id="folder_id" name="folder_name" placeholder="Folder" class="form-control" value="<?php echo $folderName ?>" autocomplete="nope">
                                                </div>
                                            </div>
        ...
        <script src="./update/update folder.js"></script>
