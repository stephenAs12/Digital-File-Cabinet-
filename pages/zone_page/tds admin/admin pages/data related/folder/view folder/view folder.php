                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-plus-square"></i><a href="../../../account related/user management/create user account/create account.php">የተጠቃሚ አካውንት ይመዝግቡ</a></li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye"></i><a href="../../school and association/view association/view association.php"><span>ጉድኝት የመልከቱ</span></a></li>
                            </ul>
                        </li>
        ...
        <div id="right-panel" class="right-panel">
                        ...
                        <div class="header-left">
                            ...
                            <div class="form-inline">
                                <form class="search-form">
                                    <input class="form-control mr-sm-2" type="text" placeholder="ይፈልጉ ..." aria-label="Search">
            ...
            <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="staticModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="staticModalLabel">አቃፊ ይፍጠሩ</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                                ...
                                <form id="folder_form_id" class="">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="folder_id" name="folder_name" placeholder="የአቃፊ ስም" class="form-control" autocomplete="nope">
                                        </div>
                                    </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <!-- <div class="col-md-6 text-right">
                                        <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#addModal"><i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp; አቃፊ ይመዝግቡ</button>
                                    </div> -->
                                </div>
                                <div class="card-body">
                                        ...
                                        <table id="example" class="display table table-striped table-bordered" style="width:100%">
                                            ...
                                            if ($result) {
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    $folderInfo = '<a href="./update folder.php?folder_id=' . $id . '&folder_name=' . $folder_name . '"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>';
                                                    echo '<tr>
                                                        <td>' . $folder_name . '</td>
                                                </tr>';
                                                }
