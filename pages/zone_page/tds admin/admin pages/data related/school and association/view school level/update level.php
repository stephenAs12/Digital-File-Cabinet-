...
?>
    ...
    <body>
            ...
            <nav class="navbar navbar-expand-sm navbar-default">
                ...
                <div id="main-menu" class="main-menu collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-american-sign-language-interpreting" style="color: white;"></i><span style="color: white;">የትምህርት ቤት ደረጃ</span></a>
                            <ul class="sub-menu children dropdown-menu">
                    ...
                    <div class="col-sm-5">
                        <div class="user-area dropdown float-right">
                            ...
                            <div class="user-menu dropdown-menu">
                                ...
                                <a class="nav-link" href="../../../account related/my account/view my account/view my account.php"><i class="fa fa-user">የኔ ማህደር</i>
                                    </a>
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li><a href="./view level.php">የትምህርት ቤት ደረጃን ማየት</a></li>
                                <li class="active">የትምህርት ቤት ደረጃን መቀየር</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="col-md-12">
                                        <strong class="card-title">የትምህርት ቤት ደረጃን መቀየር </strong>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <?php
                                    ...
                                    <div class="card-body card-block">
                                        <form id="update_level_form" class="">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <div class="input-group-addon"><i aria-hidden="true">የትምህርት ቤት ደረጃ ስም </i></div>
                                                    <input type="text" id="school_level_id" name="school_level_name" placeholder="የትምህርት ቤት ደረጃ ስም" class="form-control" value="<?php echo $levelName ?>" autocomplete="nope">
                                                </div>
                                            </div>
        ...
        <script src="./update/update level.js"></script>
