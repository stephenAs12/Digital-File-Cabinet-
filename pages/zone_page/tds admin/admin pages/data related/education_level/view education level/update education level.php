...
?>
    ...
    <body>
            ...
            <nav class="navbar navbar-expand-sm navbar-default">
                ...
                <div id="main-menu" class="main-menu collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-bolt" style="color: white;"></i><span style="color: white;">Education Level</span></a>
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye" style="color: white;"></i><a href="../../education_level/view education level/view education level.php"><span style="color: white;">View Education Level</span></a></li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li><a href="./view education level.php">View Education Level</a></li>
                                <li class="active">Update Education Level</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="col-md-12">
                                        <strong class="card-title">Update Education Level</strong>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <?php
                                    $educationLevelId = $_GET['education_level_id'];
                                    $_SESSION['educationLevelId'] = $educationLevelId;
                                    $educationLevelName = $_GET['education_level_name'];
                                    ?>

                                    <div class="card-body card-block">
                                        <form id="update_education_level_form" class="">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <div class="input-group-addon"><i aria-hidden="true">Education Level</i></div>
                                                    <input type="text" id="education_level_id" name="education_level_name" placeholder="Education Level" class="form-control" value="<?php echo $educationLevelName ?>" autocomplete="nope">
                                                </div>
                                            </div>
        ...
        <script src="./update/update education level.js"></script>
