                ...
                <div id="main-menu" class="main-menu collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-users" style="color: white;"></i><span style="color: white;">ተጠቃሚን መቆጣጠር</span></a>
                            <ul class="sub-menu children dropdown-menu">

                                <li><i class="fa fa-plus-square" style="color: white;"></i><a href="./create account.php"><span style="color: white;">የተጠቃሚ አካውንት ይፍጠሩ</span></a></li>
                                <li><i class="fa fa-eye"></i><a href="../view users/view_user.php">ተጠቃሚን ይመልከቱ</a>
                                </li>
                            </ul>
                        </li>
                                    ...
                                    <div>
                                        ...
                                        <div class="form-group col-md-4">
                                            <div class="input-group">
                                                ...
                                                <select name='role_name' id='role_id' class='form-control' required>
                                                    ...
                                                    <option value='ዞን መምሪያ ሀላፊ'>ዞን መምሪያ ሀላፊ</option>
                                                    <option value='ዞን መምህራን ማህበር ሀላፊ'>ዞን መምህራን ማህበር ሀላፊ</option>
                                                    <option value='ዞን መርሱ ባለሙያ'>ዞን መርሱ ባለሙያ</option>
                                                    <option value='ወረዳ መርሱ ሀላፊ'>ወረዳ መርሱ ሀላፊ</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-md-12">
                                            <div class="input-group">
                                                ...
                                                <?php
                                                include 'getter/get woreda.php';

                                                echo "<div class='input-group-addon' id='woreda_div_id'><i class='fa fa-sort' aria-hidden='true'></i></div>";
                                                echo "<select name='woreda_name' id='woreda_id' class='form-control'>";
                                                echo "<option value='' selected hidden>ወረዳ ይምረጡ *</option>";
                                                while ($woreda_row = mysqli_fetch_array($woreda_result)) {
