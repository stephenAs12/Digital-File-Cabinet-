        ...
        <div id="right-panel" class="right-panel">
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li class="active">መምህራንን ይመልከቱ</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            if (mysqli_connect_errno()) {
                ...
                $selectQuery = "SELECT tds.tds_id, tds.fname, tds.mname, tds.lname, tds.mother_name, tds.sex, tds.type, 
                    ...
                    tds.image, tds.other_service, tds.te_other_service, tds.reduced_service, tds.warranter_jop, tds.warranter_name, tds.warranter_salary, tds.warranter_photo, tds.registered_by
                    FROM tds
