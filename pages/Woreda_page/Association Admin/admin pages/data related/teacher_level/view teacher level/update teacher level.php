            ...
            <nav class="navbar navbar-expand-sm navbar-default">
                ...
                <div id="main-menu" class="main-menu collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-fire" style="color: white;"></i><span style="color: white;">Teacher Level</span></a>
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye" style="color: white;"></i><a href="../../teacher_level/view teacher level/view teacher level.php"><span style="color: white;">View Teacher Level</span></a></li>
                            </ul>
                        </li>
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li><a href="./view teacher level.php">View Teacher Level</a></li>
                                <li class="active">Update Teacher Level</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="col-md-12">
                                        <strong class="card-title">Update Teacher Level</strong>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <?php
                                        ...
                                        <form id="update_teacher_level_form" class="">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <div class="input-group-addon"><i aria-hidden="true">Teacher Level</i></div>
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <div class="input-group-addon"><i aria-hidden="true">Level Year</i></div>
                                                    <input type="number" id="level_year_id" name="level_year_name" placeholder="Level Year" class="form-control" value="<?php echo $levelYear ?>" autocomplete="nope">
                                                </div>
                                            </div>
