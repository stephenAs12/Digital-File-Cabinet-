...
?>
    ...
    <head>
        ...
        <?php $_SESSION['ec_current_date'] = "<script>document.write(date);</script>";?>
            ...
            <nav class="navbar navbar-expand-sm navbar-default">
                ...
                <div id="main-menu" class="main-menu collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        <li class="active">
                            <a href="./expert index.php"> <i class="menu-icon fa fa-dashboard"></i><span style="color: white;">ዳሽቦርድ</span> </a>
                        </li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-eye"></i><a href="./expert pages/account related/my account/view my account/view my account.php">አካውንቴን ማየት
                                        </a></li>
                            </ul>
                        </li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye"></i><a href="./expert pages/data related/School and association/view association/view association.php">ጉድኝት ይመልከቱ</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye"></i><a href="./expert pages/data related/school and association/view school level/view level.php">የትምህርት ቤት ደረጃ ይመልከቱ  </a></li>
                            </ul>
                        </li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye"></i><a href="./expert pages/data related/School and association/view school/view school.php">ትምህርት ቤት ይመልከቱ</a></li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye"></i><a href="./expert pages/data related/education_level/view education level/view education level.php">የትምህርት ደረጃ ይመልከቱ</a></li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye"></i><a href="./expert pages/data related/department/view department/view department.php">የትምህርት አይነት ይመልከቱ</a></li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye"></i><a href="./expert pages/data related/teacher_level/view teacher level/view teacher level.php">የመምህርነት ደረጃን ይመልከቱ</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye"></i><a href="./expert pages/data related/folder/view folder/view folder.php">አቃፊ ይመልከቱ</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-eye"></i><a href="./expert pages/human resource/tds/teacher/view teacher/view teacher.php">መምህራንን ይመልከቱ</a>
                                </li>
                                <li><i class="fa fa-pencil-square-o"></i><a href="./expert pages/human resource/tds/teacher/view teacher/update with id.php">የመምህራንን መረጃ ይቀይሩ</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-eye"></i><a href="./expert pages/human resource/tds/director/view teacher/view teacher.php">ርዕሰ መምህራንን ይመልከቱ</a>
                                </li>
                                <li><i class="fa fa-pencil-square-o"></i><a href="./expert pages/human resource/tds/director/view teacher/update with id.php">የርዕሰ መምህራንን መረጃ ይቀይሩ </a></li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-eye"></i><a href="./expert pages/human resource/tds/vice/view teacher/view teacher.php">ምክትል ርዕሰ መምህራንን ይመልከቱ</a>
                                </li>
                                <li><i class="fa fa-pencil-square-o"></i><a href="./expert pages/human resource/tds/vice/view teacher/update with id.php">የምክትል ርዕሰ መምህራንን መረጃ ይቀይሩ </a></li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-eye"></i><a href="./expert pages/human resource/tds/supervisor/view teacher/view teacher.php">ሱፐርቫይዘሮችን ይመልከቱ</a>
                                </li>
                                <li><i class="fa fa-pencil-square-o"></i><a href="./expert pages/human resource/tds/supervisor/view teacher/update with id.php">የሱፐርቫይዘሮችን መረጃ ይቀይሩ</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <a href="./expert pages/extras/developers/developers.php" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-code" aria-hidden="true" style="color: white;"></i>አበልጻጊ</a>
                        </li>
                    ...
                    <div class="col-sm-5">
                        <div class="user-area dropdown float-right">
                            ...
                            <div class="user-menu dropdown-menu">
                                ...
                                <a class="nav-link" href="./expert pages/account related/my account/view my account/view my account.php"><i class="fa fa-user"></i>
                                    የኔ ማህደር</a>
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">አቋርጥ</button>
                            ...
                            <div class="dropdown float-right">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    <div class="dropdown-menu-content">
                                        <a class="dropdown-item" href="./expert pages/data related/school and association/view association/view association.php">ይመልከቱ</a>
                        ...
                        <div class="card-body pb-0">
                            <div class="dropdown float-right">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                                    <div class="dropdown-menu-content">
                                        <a class="dropdown-item" href="./expert pages/data related/school and association/view school/view school.php">ይመልከቱ</a>
                                    </div>
                                </div>
                            </div>
                            <h4 class="mb-0">
                            ...
                            <div class="dropdown float-right">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                                    <div class="dropdoaaaa      1wn-menu-content">
                                        <a class="dropdown-item" href="./expert pages/data related/education_level/view education level/view education level.php">ይመልከቱ</a>
                                    </div>
                                </div>
                            </div>
                            <h4 class="mb-0">
                    ...
                    <div class="card text-white bg-flat-color-4">
                        <div class="card-body pb-0">
                            <div class="dropdown float-right">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                                    <div class="dropdown-menu-content">
                                        <a class="dropdown-item" href="./expert pages/data related/department/view department/view department.php">ይመልከቱ</a>
                                    </div>
                                </div>
                            </div>
                            <h4 class="mb-0">
                    ...
                    <div class="card text-white bg-flat-color-5">
                        <div class="card-body pb-0">
                            <div class="dropdown float-right">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                                    <div class="dropdown-menu-content">
                                        <a class="dropdown-item" href="./expert pages/human resource/tds/supervisor/view teacher/view teacher.php">ይመልከቱ</a>
                                    </div>
                                </div>
                            </div>
                            <h4 class="mb-0">
                    ...
                    <div class="card text-white bg-flat-color-6">
                        <div class="card-body pb-0">
                            <div class="dropdown float-right">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                                    <div class="dropdown-menu-content">
                                        <a class="dropdown-item" href="./expert pages/human resource/tds/view director/view director.php">ይመልከቱ</a>
                                    </div>
                                </div>
                            </div>
                            <h4 class="mb-0">
