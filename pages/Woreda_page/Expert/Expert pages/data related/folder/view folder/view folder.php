...
?>
    ...
    <body>
                ...
                <div id="main-menu" class="main-menu collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye"></i><a href="../../school and association/view school/view school.php"><span>ትምህርት ቤቶችን ይመልከቱ</span></a></li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                        ...
                        <li class="menu-item-has-children dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-folder" style="color: white;"></i><span style="color: white;">አቃፊ</span></a>
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye" style="color: white;"></i><a href="../../folder/view folder/view folder.php"><span style="color: white;">አቃፊን ይመልከቱ </span></a></li>
                            </ul>
                        </li>
        ...
        <div id="right-panel" class="right-panel">
            ...
            <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="staticModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="staticModalLabel">አቃፊ ይጨምሩ</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <div>
                                <form id="folder_form_id" class="">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <div class="input-group-addon"><i class="fa fa-text-width" aria-hidden="true"></i></div>
                                            <input type="text" id="folder_id" name="folder_name" placeholder="አቃፊ ስም" class="form-control" autocomplete="nope">
                                        </div>
                                    </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong class="card-title">የተመዘገቡ አቃፊወች ዝርዝር </strong>
                                </div>
                                <div class="card-body">
        ...
        <script src="./add/insert folder.js"></script>
