...
?>
    ...
    <body>
            ...
            <nav class="navbar navbar-expand-sm navbar-default">
                ...
                <div id="main-menu" class="main-menu collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <h3 class="menu-title">አካውንት ዝምድና</h3>
                        ...
                        <h3 class="menu-title">ዳታ ዝምድና</h3>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye" style="color: white;"></i><a href="./view association.php"><span style="color: white;">ጉድኝት ይመልከቱ</span></a></li>
                            </ul>
                        </li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye"></i><a href="../view school level/view level.php">የትምህርት ቤት ደረጃን ይመልከቱ</a></li>
                            </ul>
                        </li>
        ...
        <div id="right-panel" class="right-panel">
            ...
            <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="staticModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="staticModalLabel">ጉድኝት ይመዝግቡ</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                                ...
                                <form id="association_form_id" class="">
                                    <div class="form-group col-md-12">
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="association_id" name="association_name" placeholder="Association Name" class="form-control" autocomplete="nope">
                                        </div>
                                    </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong class="card-title">የተመዘገቡ ግድኝቶች ዝርዝር</strong>
                                </div>
                                <div class="card-body">
        ...
        <script src="./add/insert association.js"></script>
