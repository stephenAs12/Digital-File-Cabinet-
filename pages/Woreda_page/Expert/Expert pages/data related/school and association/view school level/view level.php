...
?>
    ...
    <head>
        ...
        <title>የትምህርት ቤት ደረጃን ይመልከቱ</title>
    ...
    <body>
                ...
                <div id="main-menu" class="main-menu collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye"></i><a href="../view association/view association.php"><span>ጉድኝቶችን ይመልከቱ</span></a></li>
                            </ul>
                        </li>

                        <li class="menu-item-has-children dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-american-sign-language-interpreting" style="color: white;"></i><span style="color: white;">የትምህርት ቤት ደረደረጃ</span></a>
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye" style="color: white;"></i><a href="./view level.php"><span style="color: white;">የትምህርት ቤት ደረጃን ይመልከቱ </span></a></li>
                            </ul>
                        </li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye"></i><a href="../view school/view school.php">ትምህርት ቤትን ይመልከቱ</a></li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-pencil-square-o"></i><a href="../../../human resource/tds/teacher/view teacher/update with id.php">የመምህራንን መረጃ ይቆይሩ</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-eye"></i><a href="../../../human resource/tds/director/view teacher/view teacher.php">የርዕሰ መምህራንን መረጃ ይቀይሩ</a>
                                </li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-pencil-square-o"></i><a href="../../../human resource/tds/supervisor/view teacher/update with id.php">የሱፐርቫይዘሮችን መረጃ ይቀይሩ</a>
                                </li>
                            </ul>
                        </li>
        ...
        <div id="right-panel" class="right-panel">
            ...
            <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="staticModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="staticModalLabel">የትምህርት ቤት ድረጃን ይመዝግቡ</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <div>
                                <form id="school_level_form_id" class="">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <div class="input-group-addon"><i class="fa fa-text-width" aria-hidden="true"></i></div>
                                            <input type="text" id="school_level_id" name="school_level_name" placeholder="የትምህት ቤት ደረጃ ስም" class="form-control" autocomplete="nope">
                                        </div>
                                    </div>
                            </div>
                        </div>
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li class="active">የትምህርት ቤት ድረጃን ይመልከቱ</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong class="card-title">የተመዘገቡ የትምህርት ቤት ደረጃ ዝርዝር</strong>
                                </div>
                                <div class="card-body">
        ...
        <script src="./add/insert level.js"></script>
