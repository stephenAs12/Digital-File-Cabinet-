...
?>
    ...
    <body>
                ...
                <div id="main-menu" class="main-menu collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye"></i><a href="../../school and association/view association/view association.php"><span>ጉድኝት ይመልከቱ</span></a></li>
                            </ul>
                        </li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye"></i><a href="../../school and association/view school level/view level.php"><span>የምትህረት ቤት ደረጃን ይመልከቱ </span></a></li>
                            </ul>
                        </li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye"></i><a href="../../school and association/view school/view school.php"><span>ትምህርት ቤትን ይመልከቱ</span></a></li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-bolt" style="color: white;"></i><span style="color: white;">የትምህረት ደረጃ</span></a>
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye" style="color: white;"></i><a href="../../education_level/view education level/view education level.php"><span style="color: white;">የትምህርት ደረጃን ይመልከቱ </span></a></li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye"></i><a href="../../department/view department/view department.php">የትምህርት አይነቶችን ይመልከቱ</a></li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye"></i><a href="../../teacher_level/view teacher level/view teacher level.php">የመምህርነት ደርጃን ይመልከቱ </a></li>
                            </ul>
                        </li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-pencil-square-o"></i><a href="../../../human resource/tds/teacher/view teacher/update with id.php">የመምህራንን መረጃ ይቀይሩይቀይሩ</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-eye"></i><a href="../../../human resource/tds/director/view teacher/view teacher.php">ርዕሰ መምህራንን ይመልከቱ</a>
                                </li>
                                <li><i class="fa fa-pencil-square-o"></i><a href="../../../human resource/tds/director/view teacher/update with id.php">የርዕሰ መምህርንን  መረጃ ይቀይሩ</a>
                                </li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-eye"></i><a href="../../../human resource/tds/vice/view teacher/view teacher.php">ምክትል ርዕሰ መምህራንን ይመልከቱ</a>
                                </li>
                                <li><i class="fa fa-pencil-square-o"></i><a href="../../../human resource/tds/vice/view teacher/update with id.php">የምክትል ርዕሰ መምህራንን መረጃ ይቀይሩ </a></li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-eye"></i><a href="../../../human resource/tds/supervisor/view teacher/view teacher.php">ሱፐርቫይዘርን ይመልከቱ</a>
                                </li>
                                <li><i class="fa fa-pencil-square-o"></i><a href="../../../human resource/tds/supervisor/view teacher/update with id.php">የሱፐርቫይዘርን ይመረጃ ይቀይሩ</a>
                                </li>
                            </ul>
                        </li>
        ...
        <div id="right-panel" class="right-panel">
            ...
            <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="staticModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="staticModalLabel">የትምህርት ደረጃን ይመዝግቡ </h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <div>
                                <form id="education_level_form_id" class="">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <div class="input-group-addon"><i class="fa fa-text-width" aria-hidden="true"></i></div>
                                            <input type="text" id="education_level_id" name="education_level_name" placeholder="የትምህርት ደረጃ" class="form-control" autocomplete="nope">
                                        </div>
                                    </div>
                            </div>
                        </div>
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li class="active">የትምህርት ደረጃን ይመልከቱ </li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong class="card-title">የተመዘገቡ የትምህርት ድረጃ ዝርዝር</strong>
                                </div>
                                <div class="card-body">
                                        ...
                                        <table id="example" class="display table table-striped table-bordered" style="width:100%">
                                            ...
                                            if ($result) {
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    $id = $row['lev_id'];
                                                    $education_level_name = $row['edu_level_name'];
                                                    echo '<tr>
        ...
        <script src="./add/insert education level.js"></script>
