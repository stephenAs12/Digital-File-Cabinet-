...
?>
    ...
    <head>
        ...
        <title>የርዕሰ መምህራንን አቃፊወች ማየት</title>
    ...
    <body>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-eye"></i><a href="../../teacher/view teacher/view teacher.php"><span>መምህርንን ይመልከ </span></a>
                                </li>
        ...
        <div id="right-panel" class="right-panel">
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li><a href="./view teacher.php">ርዕሰ መምህራንን ይመልከቱ</a></li>
            ...
            <div class="content mt-3">
                <div class="add_file">
                    <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#addFileModal"><i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp; ፋይል ይመዝግቡ </button>
                    <hr>
                </div>
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                if ($check) {
                                    ...
                                    if (mysqli_num_rows($resultFile) > 0) {
                                        ...
                                        <a href="../view teacher file/view_teacher_file.php?folder_id=' . $row['folder_id'] . '&tds_id=' . $id . '">
                    ...
                    ?>
                            <div class="col-md-4" style="overflow-y: scroll; height:80vh;">
                                <div class="mx-auto d-block">
                                    ...
                                    <hr>
                                    <div class="location text-sm-left">የመምህራን ደረጃ<i><strong><?php echo " " . $teacher_level; ?></strong></i></div>
                                    <hr>
