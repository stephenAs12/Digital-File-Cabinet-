...
?>
    ...
    <head>
        ...
        <title>የርዕሰ መምህራንን መረጃ ይቀይሩ</title>
                ...
                <div id="main-menu" class="main-menu collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-user-secret"></i>የኔ አካውን</a>
                            <ul class="sub-menu children dropdown-menu">

                                <li><i class="fa fa-eye"></i><a href="../../../../account related/my account/view my account/view my account.php">
                                        አካውንቴን ይመልከቱ</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye"></i><a href="../../../../data related/school and association/view school level/view level.php"><span>የትምህርት ቢት ደረጃን ይመልከቱ</span></a></li>
                            </ul>
                        </li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye"></i><a href="../../../../data related/department/view department/view department.php"><span>የትምህርት አይነትን ይመልከት</span></a></li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                        ...
                        <li class="menu-item-has-children dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-male"></i>መምህራን</a>
                            <ul class="sub-menu children dropdown-menu">
                        ...
                        <li class="menu-item-has-children dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-user" style="color: white;"></i><span style="color: white;">ርዕሰ መምህራን</span></a>
                            <ul class="sub-menu children dropdown-menu">

                                <li><i class="fa fa-eye"></i><a href="./view teacher.php">ርዕሰ መምህራንን ይመልከቱ</a>
                                </li>
                                <li><i class="fa fa-pencil-square-o" style="color: white;"></i><a href="./update with id.php"><span style="color: white;">የርዕሰ መምህራን መረጃ ይቀይሩ</span></a>
                                </li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-pencil-square-o"></i><a href="../../supervisor/view teacher/update with id.php">የሱፐቫይዘሮችን መረጃ ይቀይሩ</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <a href="../../../../extras/developers/developers.php" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-code" aria-hidden="true" style="color: white;"></i>አበለጻጊውች</a>
                        </li>
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li><a href="./view teacher.php">ርዕሰ መምህር ይመልከቱ</a></li>
                                <li class="#">የርዕሰ መምህር መረጃን ይቀይሩ</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <div class="content mt-3">
                <div class="animated fadeIn">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">የርዕሰ መምህራን መረጃ የቀይሩ</div>
                                <div class="card-body card-block">
                                    <form action="" method="get">
                                        <div class="form-group col-md-8">
                                            <label for="known_id_id" class="form-label">የርዕሰ መምህራን መለያ ያስገቡ
                                            </label>
                                    ...
                                    <div id="teacher_form_id" class="">
                                        ...
                                        if (isset($_GET['known_id'])) {
                                            ...
                                            $query = "SELECT tds.tds_id,tds.woreda, tds.fname, tds.mname, tds.lname, tds.mother_name, tds.sex, tds.type, 
                                                ...
                                                ON tds.association=association.asso_id WHERE tds.type='ርዕሰ መምህር' AND tds.tds_id='$known_id' AND tds.registered_by='$logged_user'";
                                    ...
                                    <div class="nameholder">
                                        ...
                                        <div class="form-group col-md-4">
                                            <div class="input-group">
                                                ...
                                                <div class='input-group-addon'><i class='' aria-hidden='true'>ዋስትና</i></div>
                                                <select name='warranty_name' id='warranty_id' class='form-control'>
                                                    ...
                                                    <option value='አለው'>አለው</option>
                                                    <option value='የለውም'>የለውም</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12" id="warranter_div_id" style="background-color: #004d4d; border: 2px double #000d0d; border-radius: 5px; margin-bottom: 20px;">
                                        ...
                                        <div class="nameholder">
                                            ...
                                            <div class="form-group col-md-4">
                                                <div class="input-group">
                                                    <div class="input-group-addon"><i>ጉርድ ፎኦ</i></div>
