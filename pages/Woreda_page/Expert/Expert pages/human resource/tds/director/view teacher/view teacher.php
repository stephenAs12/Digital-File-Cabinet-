    ...
    <body>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-eye"></i><a href="../../teacher/view teacher/view teacher.php"><span>መምህራንን ይመልከቱ </span></a>
                                </li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-user" style="color: white;"></i><span style="color: white;">ርዕሰ መምህር</span></a>
                            <ul class="sub-menu children dropdown-menu">

                                <li><i class="fa fa-eye" style="color: white;"></i><a href="./view teacher.php"><span style="color: white;">ርዕሰ መምህራንን ይመልከቱ </span></a>
                                </li>
        ...
        <div id="right-panel" class="right-panel">
            ...
            if (mysqli_connect_errno()) {
                ...
                school.name, tds.school, s_level.level_name AS s_l, association.asso_name, tds.association, tds.warranty, tds.salary, tds.shelf, tds.kent, tds.phone, 
                ...
                ON tds.association=association.asso_id WHERE type='ርዕሰ መምህር' ORDER BY tds.tds_id DESC";
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="col-md-6">
                                        <strong class="card-title">የተመዘገቡ ርዕሰ መምህራን ዝርዝር </strong>
                                    </div>
                                    <div class="col-md-6 text-right">
                                        <a href="../add.php"><button type="button" class="btn btn-success btn-sm"><i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp; ርዕሰ መምህራንን ይመዝግቡ</button></a>
                                    </div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="scroll">
                                        <table id="example" class="display table table-striped table-bordered" style="width:100%">
                                            ...
                                            while ($row = mysqli_fetch_array($result)) {
                                                ...
                                                // $date2 = strtotime($employment_period);
