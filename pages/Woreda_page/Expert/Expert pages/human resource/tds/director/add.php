                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-eye" style="color: white;"></i><a href="./view teacher/view teacher.php"><span style="color: white;">ርዕሰ መምህራንን ይመልከቱ</span></a>
                                </li>
                                <li><i class="fa fa-pencil-square-o"></i><a href="./view teacher/update with id.php">የርዕሰ መምህራንን መረጃ ይቀይሩ</a>
                                </li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li class="active">ርዕሰ መምህራንን ይመዝግቡ</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <strong>ርዕሰ መምህራንን ይመዝግቡ</strong>
                        <small> ይህንን ፎርም ይጠቀሙ
                                    ...
                                    <div class="nameholder">
                                        ...
                                        <div class="form-group col-md-4">
                                            <div class="input-group">
                                                ...
                                                <input type="text" id="te_other_id" name="te_other_name" placeholder="በመምህርነት በሌላ" class="form-control" minlength="8" maxlength="8">
                                            </div>
                                        </div>
