                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-eye"></i><a href="../../teacher/view teacher/view teacher.php">View Teacher</a>
                                </li>
                                <li><i class="fa fa-pencil-square-o"></i><a href="../../teacher/view teacher/update with id.php">Update Teacher</a>
                                </li>
                            </ul>
                        </li>

                        <li class="menu-item-has-children dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-user"  style="color: white;"></i><span  style="color: white;">Director</span></a>
                            <ul class="sub-menu children dropdown-menu">

                                <li><i class="fa fa-eye"  style="color: white;"></i><a href="../view teacher/view teacher.php"><span  style="color: white;">View Director</span></a>
                                </li>
                                <li><i class="fa fa-pencil-square-o"></i><a href="../view teacher/update with id.php">Update Director</a>
                                </li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li><a href="../view teacher/view teacher.php">ርዕሰ መምህራንን ይመልከቱ</a></li>
                                <li class="active">ፋይል ይመልከቱ</li>
                            </ol>
                        </div>
                    </div>
                </div>
