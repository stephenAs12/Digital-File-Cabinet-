                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-eye" style="color: white;"></i><a href="./view teacher/view teacher.php"><span style="color: white;">ሱፐርቫይዘሮችን ይመልከቱ</span></a>
                                </li>
                                <li><i class="fa fa-pencil-square-o"></i><a href="./view teacher/update with id.php">የሱፐርቫይዘሮችን መረጃ ይቀይሩ</a>
                                </li>
                            </ul>
                        </li>
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li class="active">ሱፐርቫይዘር ይመዝግቡ</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="nameholder">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name='type_name' id='type_id' class='form-control' required>
                                            <option value='' selected hidden> የመርሱ አይነት *</option>
