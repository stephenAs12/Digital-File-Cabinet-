            ...
            <nav class="navbar navbar-expand-sm navbar-default">
                ...
                <div id="main-menu" class="main-menu collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-users" style="color: white;"></i><span style="color: white;">Supervisor</span></a>
                            <ul class="sub-menu children dropdown-menu">

                                <li><i class="fa fa-eye" style="color: white;"></i><a href="../view teacher/view teacher.php"><span style="color: white;">View Supervisor</span></a>
                                </li>
                                <li><i class="fa fa-pencil-square-o"></i><a href="../view teacher/update with id.php">Update Supervisor</a>
                                </li>
                            </ul>
                        </li>
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li><a href="../view teacher/view teacher.php">ሱፐርቫይዘር ይመልከቱ</a></li>
