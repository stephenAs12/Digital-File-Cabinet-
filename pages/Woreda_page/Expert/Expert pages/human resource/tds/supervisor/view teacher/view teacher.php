                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-eye" style="color: white;"></i><a href="./view teacher.php"><span style="color: white;">ሱፐርቫይዘሮችን ይመልከቱ</span></a>
                                </li>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="col-md-6">
                                        <strong class="card-title">የተመዘገቡ ሱፐርቫይዘሮችን ዝርዝር ይመልከቱ</strong>
                                    </div>
                                    <div class="col-md-6 text-right">
                                        <a href="../add.php"><button type="button" class="btn btn-success btn-sm"><i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp; ሱፐርቫይዘሮችን ይመዝግቡ</button></a>
                                    </div>
                                </div>
                                <div class="card-body">
