            ...
            <nav class="navbar navbar-expand-sm navbar-default">
                ...
                <div id="main-menu" class="main-menu collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <h3 class="menu-title">አካውንት ተሻማጅ</h3><!-- /.menu-title -->
                        ...
                        <li class="menu-item-has-children dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-bolt"></i><span>የትምህርት ድረጃ</span></a>
                            <ul class="sub-menu children dropdown-menu">
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye"></i><a href="../../../data related/teacher_level/view teacher level/view teacher level.php"><span>የመምህራን ደረጃን ይመልከቱ</span></a></li>
                            </ul>
                        </li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-pencil-square-o"></i><a href="../teacher/view teacher/update with id.php">የርዕሰ መንህራንን መረጃ ይቀይሩ</a>
                                </li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-pencil-square-o"></i><a href="../teacher/view teacher/update with id.php">የሱፐርቫይዘሮችን መረጃ ይቀይሩ</a>
                                </li>
                            </ul>
                        </li>
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li><a href="./view teacher/view teacher.php">ምክትል ርዕሰ መምህር ይመልከቱ</a></li>

                                <li class="active">ምክትል ርዕሰ መምህር ይወምሩ</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <strong>ምክትል ርዕሰ መምህር ይጨምሩ</strong>
                        <small>ይህንን ፎርም ይጠቀሙ
