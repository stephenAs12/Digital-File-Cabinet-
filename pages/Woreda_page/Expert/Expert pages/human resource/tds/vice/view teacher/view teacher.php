...
?>
    ...
    <head>
        ...
        <title>ምክትል ርዕሰ መምህራኖችን ይመልከቱ</title>
    ...
    <body>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-eye"></i><a href="../../teacher/view teacher/view teacher.php"><span>መምህርንን ይመልከቱ </span></a>
                                </li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-eye" style="color: white;"></i><a href="./view teacher.php"><span style="color: white;">ምክትል ርዕሰ መምህራንን ይመልከቱ</span></a>
                                </li>
                                <li><i class="fa fa-pencil-square-o"></i><a href="./update with id.php">የምክትል ርዕሰ መምህራንን መረጃ ይቀይሩ </a></li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
        ...
        <div id="right-panel" class="right-panel">
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li class="#">ምክትል ርዕሰ መምህራኖችን ይመልከቱ</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            if (mysqli_connect_errno()) {
                ...
                ON tds.association=association.asso_id WHERE type='ምክትል ርዕሰ መምህር' ORDER BY tds.tds_id DESC";
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="col-md-6">
                                        <strong class="card-title">የተመዘገቡ ምክትል ርዕሰ መምህራኖችን ዝርዝር ይመልከቱ</strong>
                                    </div>
                                    <div class="col-md-6 text-right">
                                        <a href="../add.php"><button type="button" class="btn btn-success btn-sm"><i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp; ምክትል ርዕሰ መምህራኖችን ይመዝግቡ</button></a>
                                    </div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="scroll">
                                        <table id="example" class="display table table-striped table-bordered" style="width:100%">
                                            <thead>
                                                ...
                                                <th style="font-size: 13px;  padding: 2px;">መምህርነት በሌላ</th>
