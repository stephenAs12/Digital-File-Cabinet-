                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-eye"></i><a href="./view teacher.php">View Teacher</a>
                                </li>
                                <li><i class="fa fa-pencil-square-o" style="color: white;"></i><a href="./update with id.php"><span style="color: white;">Update Teacher</span></a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-eye"></i><a href="../../view director/view director.php">View Director</a>
                                </li>
                                <li><i class="fa fa-pencil-square-o"></i><a href="./update with id.php">Update Director</a>
                                </li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-eye"></i><a href="../../view supervisor/view supervisor.php">View Supervisor</a>
                                </li>
                                <li><i class="fa fa-pencil-square-o"></i><a href="./update with id.php">Update Supervisor</a>
                                </li>
                            </ul>
                        </li>
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li><a href="./view teacher.php">View Teachers</a></li>
                                <li class="#">Update Teacher</li>
                            </ol>
                        </div>
                    </div>
                </div>
