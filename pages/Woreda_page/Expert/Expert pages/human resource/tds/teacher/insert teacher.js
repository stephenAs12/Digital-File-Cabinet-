...
jQuery(document).ready(function(){
    ...
    var birthDate = jQuery('#birth_day_id').val();
    var employmentPeriod = jQuery('#emp_period_id').val();
    var penalty = jQuery('#penalty_id').val();
            ...
            jQuery.ajax({
                ...
                success: function (data) {
                    if (parseInt(data) === parseInt(1)) {
                        ...
                        jQuery('#image_id').val("");
                        jQuery('#phone_id').val("");
                        jQuery('#birth_day_id').val("");
                        jQuery('#emp_period_id').val("");
                        jQuery('#reduced_service_id').val("");
                        jQuery('#te_other_id').val("");
                        jQuery('#other_id').val("");
                        jQuery('#association_id').val("");
                        jQuery('#school_id').val("");
                        jQuery('#school_level_id').val("");
