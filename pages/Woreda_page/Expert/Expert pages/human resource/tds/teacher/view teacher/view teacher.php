...
?>
    ...
    <head>
        ...
        <script>
            ...
            var etYear = date.formatYear();
            var etMounth = date.month();
            var etDay = date.day();
        </script>
        <?php
        $date = "<script>document.write(ddd);</script>";
        $ec_date = "<script>document.write(etDay);</script>";
        $ec_month = "<script>document.write(etMounth);</script>";
        $ec_year = "<script>document.write(etYear);</script>";
        ?>
    ...
    <body>
                ...
                <div id="main-menu" class="main-menu collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye"></i><a href="../../../../data related/school and association/view association/view association.php"><span>ጉድኝትን ይመልከቱ</span></a></li>
                            </ul>
                        </li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye"></i><a href="../../../../data related/school and association/view school level/view level.php"><span>የትምህርት ቤት ደርጃን ይመልከቱ</span></a></li>
                            </ul>
                        </li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye"></i><a href="../../../../data related/school and association/view school/view school.php"><span>ትምህርት ቤትን ይመልከቱ</span></a></li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye"></i><a href="../../../../data related/department/view department/view department.php"><span>የትምህርት አይነቶችን ይመልከቱ</span></a></li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-eye" style="color: white;"></i><a href="./view teacher.php"><span style="color: white;">መምህርንን ይመልከ </span></a>
                                </li>
                                <li><i class="fa fa-pencil-square-o"></i><a href="./update with id.php">የመምህራንን መረጃ ይቀይሩ</a>
                                </li>
                            </ul>
                        </li>
        ...
        <div id="right-panel" class="right-panel">
            ...
            if (mysqli_connect_errno()) {
                ...
                dept.dept_name, teach.dept_name AS teaches_sub, mino.dept_name AS minor_sub, thre.dept_name AS three_sub, tds.teaches, tds.department, tds.minor, tds.3_major, tds.retirement_number, 
                school.name, tds.school, s_level.level_name AS s_l, teacher_level.level_name, tds.teacher_level, association.asso_name, tds.association, tds.warranty, tds.salary, tds.shelf, tds.kent, tds.phone, 
                tds.image, tds.other_service, tds.te_other_service, tds.reduced_service, tds.warranter_jop, tds.warranter_name, tds.warranter_salary, tds.warranter_photo, tds.warranter_photo, tds.yw,
                ...
                ON tds.school=school.id
                 INNER JOIN school_level AS s_level
                ON tds.school_level=s_level.level_id
                INNER JOIN teacher_level
                ON tds.teacher_level=teacher_level.level_id
                INNER JOIN association
                ON tds.association=association.asso_id WHERE tds.type='መምህር' ORDER BY tds.tds_id DESC";
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="col-md-6">
                                        <strong class="card-title">የተመዘገቡ መምህራን ዝርዝር </strong>
                                    </div>
                                    <div class="col-md-6 text-right">
                                        <a href="../add.php"><button type="button" class="btn btn-success btn-sm"><i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp; መምህራንን ይመዝግቡ</button></a>
                                    </div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="scroll">
                                        <table id="example" class="display table table-striped table-bordered" style="width:100%">
                                            <thead>
                                                <tr>
                                                    <th style="font-size: 13px;  padding: 2px;">ክፈት</th>
                                                    ...
                                                    <th style="font-size: 13px;  padding: 2px;">የሚያስተምረው</th>
                                                    ...
                                                    <th style="font-size: 13px;  padding: 2px;">ት/ቤት ደረጃ</th>
                                                    ...
                                                    <th style="font-size: 13px;  padding: 2px;">ዋስ አለው?</th>
                                                    ...
                                                    <th style="font-size: 13px;  padding: 2px;">ዋስ ሁኗል?</th>
                                                    <th style="font-size: 13px;  padding: 2px;">ሙሉ ስም</th>
                                                    <th style="font-size: 13px;  padding: 2px;">ተቋም</th>
                                                    <th style="font-size: 13px;  padding: 2px;">ምክንያት</th>
                                                    <th style="font-size: 13px;  padding: 2px;">ብድር አለበት?</th>
                                                    <th style="font-size: 13px;  padding: 2px;">የብድር አይነት</th>
                                                    <th style="font-size: 13px;  padding: 2px;">ቦታ ተደራጅቷል?</th>
                                                    <th style="font-size: 13px;  padding: 2px;">የተደራጀበት ዘመን</th>
                                            ...
                                            while ($row = mysqli_fetch_array($result)) {
                                                ...
                                                echo '
                                                    <tr>
                                                        ...
                                                        <td style="font-size: 13px;  padding: 2px;">' . $teaches . '</td>
                                                        ...
                                                        <td style="font-size: 13px;  padding: 2px;">' . $s_l . '</td>
                                                        ...
                                                        <td style="font-size: 13px;  padding: 2px;">' . $yw . '</td>
                                                        <td style="font-size: 13px;  padding: 2px;">' . $yw_full_name . '</td>
                                                        <td style="font-size: 13px;  padding: 2px;">' . $yw_inst_name . '</td>
                                                        <td style="font-size: 13px;  padding: 2px;">' . $yw_re_name . '</td>
                                                        <td style="font-size: 13px;  padding: 2px;">' . $cr . '</td>
                                                        <td style="font-size: 13px;  padding: 2px;">' . $cr_dr . '</td>
                                                        <td style="font-size: 13px;  padding: 2px;">' . $pl . '</td>
                                                        <td style="font-size: 13px;  padding: 2px;">' . $place_day . '</td>
