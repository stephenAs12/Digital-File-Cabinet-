    ...
    <body>
            ...
            <nav class="navbar navbar-expand-sm navbar-default">
                ...
                <div id="main-menu" class="main-menu collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        <li>
                            <a href="../../../../../expert index.php"> <i class="menu-icon fa fa-dashboard"></i><span>Dashboard</span> </a>
                        </li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye"></i><a href="../../../../data related/school and association/view association/view association.php"><span>View Association</span></a></li>
                            </ul>
                        </li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye"></i><a href="../../../../data related/school and association/view school level/view level.php"><span>View School Level</span></a></li>
                            </ul>
                        </li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye"></i><a href="../../../../data related/school and association/view school/view school.php"><span>View School</span></a></li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye"></i><a href="../../../../data related/education_level/view education level/view education level.php"><span>View Education Level</span></a></li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye"></i><a href="../../../../data related/department/view department/view department.php"><span>View Department</span></a></li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye"></i><a href="../../../../data related/teacher_level/view teacher level/view teacher level.php"><span>View Teacher Level</span></a></li>
                            </ul>
                        </li>

                        <li class="menu-item-has-children dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-folder"></i><span>Folder</span></a>
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye"></i><a href="../../../../data related/folder/view folder/view folder.php"><span>View Folder</span></a></li>
                            </ul>
                        </li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-male" style="color: white;"></i><span style="color: white;">Teacher</span></a>
                            <ul class="sub-menu children dropdown-menu">

                                <li><i class="fa fa-eye" style="color: white;"></i><a href="../view teacher/view teacher.php"><span style="color: white;">View Teacher</span></a>
                                </li>
                                <li><i class="fa fa-pencil-square-o"></i><a href="../view teacher/update with id.php">Update Teacher</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-eye"></i><a href="../../director/view teacher/view teacher.php">View Director</a>
                                </li>
                                <li><i class="fa fa-pencil-square-o"></i><a href="../../director/view teacher/update with id.php">Update Director</a>
                                </li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-eye"></i><a href="../../supervisor/view teacher/view teacher.php">View Supervisor</a>
                                </li>
                                <li><i class="fa fa-pencil-square-o"></i><a href="../../supervisor/view teacher/update with id.php">Update Supervisor</a>
                                </li>
                            </ul>
                        </li>
        ...
        <div id="right-panel" class="right-panel">
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                <li><a href="../../../../../expert index.php">Dashboard</a></li>
                                <li><a href="../view teacher/view teacher.php">View Teacher</a></li>
            ...
            <div class="content mt-3">
                <div>
                    <div class="add_file">
                        <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#addFileModal"><i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp; Add file</button>
                        <hr>
                    </div>
