                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-eye" style="color: white;"></i><a href="../teacher/view teacher/view teacher.php"><span style="color: white;">መምህራንን ይመልከቱ</span></a>
                                </li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-pencil-square-o"></i><a href="../director/view teacher/update with id.php">የርዕሰ መምህራንን መረቃ ይቀይሩ</a>
                                </li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li><a href="./view teacher/view teacher.php">መምህራንን ይመልከቱ</a></li>

                                <li class="active">መምህራንን ይመዝግቡ</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="form-group col-md-4">
                                        <div class="input-group">
                                            ...
                                            <select name='sex_name' id='sex_id' class='form-control' required>
                                                <option value='' selected hidden> ፆታ *</option>
                                ...
                                <div class="nameholder">
                                    ...
                                    <div class="form-group col-md-4">
                                        <div class="input-group">
                                            ...
                                            echo "<div class='input-group-addon'><i class='fa fa-sort' aria-hidden='true'></i></div>";
                                            echo "<select name='teaches_name' id='teaches_id' class='form-control' required>";
                                            echo "<option value='' selected hidden>አሁን የሚያስተምሩት የትምህርት አይነት *</option>";
                                            while ($department_row = mysqli_fetch_array($department_result)) {
                                                echo "<option value='$department_row[dept_id]'>$department_row[dept_name]</option>";
                                            }
