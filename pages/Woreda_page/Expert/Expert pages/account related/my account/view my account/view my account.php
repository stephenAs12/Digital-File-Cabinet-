                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-eye" style="color: white;"></i><a href="./view my account.php"><span style="color: white;">View my account</span></a></li>
                            </ul>
                        </li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye"></i><a href="../../../data related/department/view department/view department.php">የትምህርት አይነት ይመልከቱ</a></li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye"></i><a href="../../../data related/teacher_level/view teacher level/view teacher level.php">የመምህርነት ደረጃ ይመልከቱ </a></li>
                            </ul>
                        </li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-pencil-square-o"></i><a href="../../../human resource/tds/teacher/view teacher/update with id.php">የመምህራንን መረጃ ይቀይሩ </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-pencil-square-o"></i><a href="../../../human resource/tds/director/view teacher/update with id.php">የርዕሰ መምህራንን መረጃ ይቀይሩ </a>
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-eye"></i><a href="../../../human resource/tds/supervisor/view teacher/view teacher.php">ሱፐርቫይዘሮችን ይመልከቱ</a>
                                </li>
                                <li><i class="fa fa-pencil-square-o"></i><a href="../../../human resource/tds/teacher/view teacher/update with id.php">የሱፐርቫይዘሮችን መረጃ ይቀይሩ </a>
                                </li>
                        </li>
                    </ul>
                    </li>
                                ...
                                <form enctype="multipart/form-data" id="verify_me_form" class="">
                                    <div class="form-group col-md-12">
                                        <div class="input-group">
                                            ...
                                            <input type="password" id="oldpassword_id" name="oldpassword_name" placeholder="የቆየው የይለፍ ቃል" class="form-control" autocomplete="nope" required>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <div class="input-group">
                                            <div class="input-group-addon"><i class="fa fa-asterisk"></i></div>
                                            <input type="password" id="new_password_id" name="new_password_name" placeholder="አድስ የይለፍ ቃል" class="form-control" autocomplete="nope">
                                        </div>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <div class="input-group">
                                            <div class="input-group-addon"><i class="fa fa-asterisk"></i></div>
                                            <input type="password" id="conf_password_id" name="conf_password_name" placeholder="የይለፍ ቃልወን ያረጋግጡ" class="form-control" autocomplete="nope">
                                        </div>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <div class="input-group">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button class="btn btn-primary" type="submit" id="verify_submit_id" name="submit"><i class="fa fa-check-circle-o" aria-hidden="true"></i> ያረጋግጡ</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="mx-auto d-block">
                                        ...
                                        <div class="location text-sm-center"><i class="fa fa-map-marker"></i> <?php echo  $_SESSION['user_woreda']; ?>,
                                            Ethiopia</div>
                                    ...
                                    <div class="card-text text-sm-center">
                                        ...
                                        <a class="nav-link" href="#" data-toggle="modal" data-target="#updateModal"><button class="btn btn-primary"><i class="fa fa-pencil" aria-hidden="true"></i> ይቀይሩ</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
