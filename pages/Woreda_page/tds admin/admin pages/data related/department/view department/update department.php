...
?>
    ...
    <body>
                ...
                <div id="main-menu" class="main-menu collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-users"></i>ተጠቃሜወችን ይቆጣጠሩ</a>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye" style="color: white;"></i><a href="../../department/view department/view department.php"><span style="color: white;">የትምህርት አይነት</span></a></li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                <li><a href="../../../../admin index.php">ድሽቦርድ</a></li>
                                <li><a href="./view department.php">የትምህርት አይነትን ይመልከቱ</a></li>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="col-md-12">
                                        <strong class="card-title">የትምህርት አይነትን ይመልከቱ</strong>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <?php
                                    ...
                                    <div class="card-body card-block">
                                        <form id="update_department_form" class="">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <div class="input-group-addon"><i aria-hidden="true">የትምህርት አይነት</i></div>
                                                    <input type="text" id="department_id" name="department_name" placeholder="የትምህርት አይነት" class="form-control" value="<?php echo $departmentName ?>" autocomplete="nope">
                                                </div>
                                            </div>
        ...
        <script src="./update/update department.js"></script>
