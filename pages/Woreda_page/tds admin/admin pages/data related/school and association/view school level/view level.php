                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-plus-square"></i><a href="../../../account related/user management/create user account/create account.php">ተጠቃሚወችን ይመዝግቡ</a></li>
                                <li><i class="fa fa-eye"></i><a href="../../../account related/user management/view users/view_user.php">ተጠቃሚወችን ይመልከቱ</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-american-sign-language-interpreting" style="color: white;"></i><span style="color: white;">የትምህርት ደረጃ</span></a>
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye" style="color: white;"></i><a href="./view level.php"><span style="color: white;">የትምህርት ደረጃ ይመልከቱ</span></a></li>
                            </ul>
                        </li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye"></i><a href="../view school/view school.php">ትምህርት ቤቶችን ይመልከቱ</a></li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye"></i><a href="../../folder/view folder/view folder.php">አቃፊወችን ይመልከቱ</a></li>
                            </ul>
                        </li>
        ...
        <div id="right-panel" class="right-panel">
            ...
            <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="staticModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="staticModalLabel">የትምህርት ቤት ደረጃ ይመዝግቡ</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                                ...
                                <form id="school_level_form_id" class="">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="school_level_id" name="school_level_name" placeholder="School Level Name" class="form-control" autocomplete="nope">
                                        </div>
                                    </div>
                            </div>
                        </div>
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li class="active">ትምህርት ቤቶችን ይመልከቱ</li>
                            </ol>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <!-- <div class="col-md-6 text-right">
                                        <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#addModal"><i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp; የትምህርት ቤት ደረጃን ይመዝግቡ</button>
                                    </div> -->
                                </div>
                                <div class="card-body">
                                        ...
                                        <table id="example" class="display table table-striped table-bordered" style="width:100%">
                                            ...
                                            if ($result) {
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    $levelInfo = '<a href="./update level.php?level_id=' . $id . '&level_name=' . $level_name . '"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>';
                                                    echo '<tr>
                                                        <td>' . $level_name . '</td>
                                                </tr>';
                                                }
