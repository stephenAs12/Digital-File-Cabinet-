...
?>
    ...
    <head>
        ...
        <title>የመምህርነት ደረጃን ይመልከቱ</title>
                ...
                <div id="main-menu" class="main-menu collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye" style="color: white;"></i><a href="../../teacher_level/view teacher level/view teacher level.php"><span style="color: white;">የመምህርነት ደረጃን ይመልከቱ </span></a></li>
                            </ul>
                        </li>
        ...
        <div id="right-panel" class="right-panel">
            ...
            <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="staticModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="staticModalLabel">የመምህርነት ደረጃን ይመዝግቡ </h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                                ...
                                <form id="teacher_level_form_id" class="">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="teacher_level_id" name="teacher_level_name" placeholder="የመምህር ደረጃ" class="form-control" autocomplete="nope">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <div class="input-group-addon"><i class="fa fa-sort-numeric-asc" aria-hidden="true"></i></div>
                                            <input type="number" id="level_year_id" name="level_year_name" placeholder="ደረጃ ዓመት" class="form-control" autocomplete="nope">
                                        </div>
                                    </div>
                            </div>
                        </div>
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li class="active">የመምህርነት ደረጃ</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="col-md-6">
                                        <strong class="card-title">የተመዘገበ የመምህርነት ደረጃ ዝርዝር</strong>
                                    </div>
                                    <!-- <div class="col-md-6 text-right">
                                        <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#addModal"><i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp; የመምህርነት ደረጃን ይመዝግቡ</button>
                                    </div> -->
                                </div>
                                <div class="card-body">
                                        ...
                                        <table id="example" class="display table table-striped table-bordered" style="width:100%">
                                            ...
                                            if ($result) {
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    $level_year = $row['year'];
                                                    $levelInfo = '<a href="./update teacher level.php?level_id=' . $id . '&level_name=' . $level_name . '&level_year=' . $level_year . '"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>';
                                                    echo '<tr>
                                                        <td>' . $level_name . '</td>
                                                        <td>' . $level_year . '</td>
                                                </tr>';
