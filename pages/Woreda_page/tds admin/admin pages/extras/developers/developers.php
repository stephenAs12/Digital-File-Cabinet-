...
?>
    ...
    <head>
        ...
        <title>Admin Page | Developers </title>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-plus-square"></i><a href="../../account related/user management/create user account/create account.php">ተጠቃሚወችን ይፍጠሩ </a></li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye"></i><a href="../../data related/school and association/view school level/view level.php"> የምትህርት ቤት ድረጃን ይመልከቱ</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-eye"></i><a href="../../data related/department/view department/view department.php">የትምህርት አይነቶችን ይምልከቱ</a></li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                        ...
                        <li>
                            <a href="./admin pages/extras/developers/developers.php" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-code" aria-hidden="true" style="color: white;"></i><span style="color: white;">አበልጻጊ</span></a>
                        </li>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="mx-auto d-block">
                                        ...
                                        <div class="location text-sm-center"><i class="fa fa-map-marker"></i><a href="https://www.google.com/maps/place/Bahir+Dar/@11.5816866,37.310382,12z/data=!3m1!4b1!4m5!3m4!1s0x1644d23307d78069:0xab0b134f632dff8!8m2!3d11.5742086!4d37.3613533" target="_blank"> Bahir Dar, Ethiopia</a></div>
                                        <div class="location text-sm-center"><i class="fa fa-telegram" aria-hidden="true"></i> <a href="https://t.me/ababimami" target="_blank">on telegram</a></div>
