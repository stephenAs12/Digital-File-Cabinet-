    ...
    <body>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-plus-square"></i><a href="../../../account related/user management/create user account/create account.php">የተጠቃኪ አካውንት ይፍጠሩ</a></li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-eye" style="color: white;"></i><a href="../../../human resource/tds/view director/view director.php"><span style="color: white;">ርዕሰ መምህራንን ይመልከቱ</span></a>
                                </li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                        ...
                        <li class="menu-item-has-children dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-users"></i><span>ሱፐርቫይዘር</span></a>
                            <ul class="sub-menu children dropdown-menu">

                                <li><i class="fa fa-eye"></i><a href="../../../human resource/tds/view supervisor/view supervisor.php"><span>ሱፐርቫይዘርን ይመልከቱ</span></a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <a href="../../../extras/developers/developers.php" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-code" aria-hidden="true"></i>አመልጻጊ</a>
                        </li>
        ...
        <div id="right-panel" class="right-panel">
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li class="active">ርዕሰ መምህራንን ይመልከቱ</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            if (mysqli_connect_errno()) {
                ...
                ON tds.association=association.asso_id WHERE tds.type='ርዕሰ መምህር' ORDER BY tds.tds_id DESC";
