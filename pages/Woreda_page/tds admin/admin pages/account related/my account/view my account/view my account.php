                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-plus-square"></i><a href="../../user management/create user account/create account.php">ተጠቃሚወችን ይፍጠሩ</a></li>
                                <li><i class="fa fa-eye"></i><a href="../../user management/view users/view_user.php">ተጠቃሚ ይመልከቱ</a>
                                </li>
                            </ul>
                        </li>
                ...
                <div class="col-sm-4">
                    <div class="page-header float-left">
                        <div class="page-title">
                            <h1><?php echo $_SESSION['user_woreda'] . " " . $_SESSION['user_role']; ?> ዳሽቦድ</h1>
                        </div>
                    </div>
                </div>
                <div class="col-sm-8">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="mx-auto d-block">
                                        ...
                                        <div class="location text-sm-center"><i class="fa fa-map-marker"></i> <?php echo  $_SESSION['user_region'].' '.$_SESSION['user_woreda']; ?>,
                                            Ethiopia</div>
